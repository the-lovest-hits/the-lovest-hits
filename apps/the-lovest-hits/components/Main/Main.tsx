      ...
      <div className="container-fluid">
            ...
            <div className="hero owl-carousel" id="hero">
              <div className="hero__slide" data-bg="img/home/slide1.jpg">
                ...
                <div className="hero__btns">
                  <a href="#" className="hero__btn hero__btn--green">
                    Buy now
                  </a>
              ...
              <div className="hero__slide" data-bg="img/home/slide2.jpg">
                <h2 className="hero__title">
                  Metallica and Slipknot feature in trailer for ‘Long Live Rock’
                  documentary
                </h2>
                <p className="hero__text">
                  It also features Rage Against The Machine, Guns N' Roses and a
                  number of others
                </p>
                <div className="hero__btns">
                  <a href="#" className="hero__btn hero__btn--green">
        ...
        <section className="row row--grid">
          ...
          <div className="col-6 col-sm-4 col-lg-2">
            <div className="album">
              ...
              <div className="album__title">
                <h3>
                  <a href="#">Space Melody</a>
                </h3>
                <span>
                  <a href="#">VIZE</a> & <a href="#">Alan Walker</a> &{' '}
                  <a href="#">Leony</a>
                </span>
              </div>
            </div>
          ...
          <div className="col-6 col-sm-4 col-lg-2">
            <div className="album">
              ...
              <div className="album__title">
                <h3>
                  <a href="#">I Love My Country</a>
                </h3>
                <span>
                  <a href="#">Florida Georgia</a>
                </span>
              </div>
            </div>
          </div>
              ...
              <div className="col-12">
                <ul className="main__list">
                  ...
                  <li className="single-item">
                    ...
                    <span className="single-item__rate single-item__rate--red">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                      >
              ...
              <div className="col-12">
                <ul className="main__list">
                  <li className="single-item">
                    ...
                    <span className="single-item__time single-item__time--live">
                      LIVE
                    </span>
                  </li>
                  <li className="single-item">
        ...
        <section className="row row--grid" hidden={true}>
          ...
          <div className="col-12">
            <div className="main__title">
              ...
              <a href="podcasts.html" className="main__link">
                See all{' '}
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <path d="M17.92,11.62a1,1,0,0,0-.21-.33l-5-5a1,1,0,0,0-1.42,1.42L14.59,11H7a1,1,0,0,0,0,2h7.59l-3.3,3.29a1,1,0,0,0,0,1.42,1,1,0,0,0,1.42,0l5-5a1,1,0,0,0,.21-.33A1,1,0,0,0,17.92,11.62Z" />
                </svg>
        ...
        <section className="row row--grid" hidden={true}>
          ...
          <div className="col-12">
            <div className="main__carousel-wrap">
              <div
                className="main__carousel main__carousel--store owl-carousel"
                id="store"
              >
                <div className="product">
                  ...
                  <h3 className="product__title">
                    <a href="product.html">Vinyl Player</a>
                  </h3>
                ...
                <div className="product">
                  ...
                  <h3 className="product__title">
                    <a href="product.html">Microphone R4</a>
                  </h3>
                ...
                <div className="product">
                  ...
                  <h3 className="product__title">
                    <a href="product.html">Music Blank</a>
                  </h3>
                ...
                <div className="product">
                  ...
                  <h3 className="product__title">
                    <a href="product.html">Headphones ZR-991</a>
                  </h3>
                ...
                <div className="product">
                  ...
                  <h3 className="product__title">
                    <a href="product.html">Microphone R4s</a>
                  </h3>
                  <span className="product__price">$199</span>
                </div>
              </div>
        ...
        <section className="row row--grid">
          ...
          <div className="col-12 col-sm-6 col-lg-4">
            <div className="post">
              ...
              <a
                href="http://www.youtube.com/watch?v=0O2aH4XLbto"
                className="post__video open-video"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <path d="M16,10.27,11,7.38A2,2,0,0,0,8,9.11v5.78a2,2,0,0,0,1,1.73,2,2,0,0,0,2,0l5-2.89a2,2,0,0,0,0-3.46ZM15,12l-5,2.89V9.11L15,12ZM12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Z" />
                </svg>
              ...
              <div className="post__content">
                ...
                <h3 className="post__title">
                  <a href="#">
                    Foo Fighters share new live version of ‘No Son Of Mine’
                  </a>
                </h3>
          ...
          <div className="col-12 col-sm-6 col-lg-4">
            <div className="post">
              ...
              <div className="post__content">
                ...
                <h3 className="post__title">
                  <a href="#">
                    Tom Grennan ‘breaks the internet’ as fans overload servers
                    during virtual gig
                  </a>
                </h3>
                <div className="post__meta">
          ...
          <div className="col-12 col-sm-6 col-lg-4">
            <div className="post">
              ...
              <div className="post__content">
                ...
                <h3 className="post__title">
                  <a href="#">
                    Why do the Golden Globes always get it so wrong?
                  </a>
                </h3>
                <div className="post__meta">
                  <span className="post__date">
